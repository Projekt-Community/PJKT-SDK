    ...
    public class PjktFileExporter //: IDisposable
    {
        ...
        public static void Test()
        {
            if(Selection.activeObject is GameObject)
            {
                ...
                PjktFileExporter exporter = new PjktFileExporter(community);
        ...
        public PjktFileExporter(Community communityInfo)
        {
            CommunityInfo = communityInfo;
            TempDirectory = Path.GetTempPath() + "PjktSdk\\" + communityInfo.name;
        }
        
        public void CreateBoothfile(GameObject booth)
        {
            if (booth == null)
            {
            ...
            string boothName = CommunityInfo.name + "_" + booth.name;
            ...
            CreateTempfolders(CommunityInfo.name);
